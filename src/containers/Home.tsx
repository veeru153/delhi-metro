    ...
    return <>
        <div className="flex flex-col justify-center items-center h-screen gap-y-10">
            ...
            <div className="flex flex-row w-4/5 mx-auto gap-x-4">
                <a
                    className="flex flex-row flex-1 justify-center items-center text-gray-50 bg-red-700 gap-x-2 py-4 rounded-xl"
                ...
                <Link className="flex flex-row flex-1 justify-center items-center text-gray-50 bg-red-700 gap-x-2 py-4 rounded-xl" to="/map">
